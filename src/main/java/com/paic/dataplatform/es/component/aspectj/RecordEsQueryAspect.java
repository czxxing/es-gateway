package com.paic.dataplatform.es.component.aspectj;
...
import com.paic.dataplatform.es.component.safegard.EmptySafeGuard;
import com.paic.dataplatform.es.component.safegard.SafeGuardException;
import com.paic.dataplatform.es.component.safegard.SafeGuardGroup;
import com.paic.dataplatform.es.event.RequestEsEvent;
import com.paic.dataplatform.es.event.ResposeEsEvent;
...
public class RecordEsQueryAspect {
    ...
    @Pointcut("execution(* com.paic.dataplatform.es.controller.EsQueryController.*(..))")
    ...
    private void postResposeEvent(String uuid,HttpServletRequest request,HttpServletResponse response,  double ttl){
        ...
        try{
            ...
            if(wrapper != null) {
                ...
                ResposeEsEvent resposeEsEvent = new ResposeEsEvent(uuid,localConfig.getHost(),localConfig.getPort(),key,body, buf.length, ttl, DateUtils.getCurrentDateTime(),null);
